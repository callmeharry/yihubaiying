            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu active">
                    ...
                    <ul class="sub open">
                        ...
                        <li class="active"><a href="http://mongodb.github.io/tutorials/aggregation/"> Aggregation </a>
                        </li>
                ...
                <li><a href="https://github.com/mongodb/node-mongodb-native/docs/content/tutorials/aggregation.md"
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <p>The aggregation framework lets you transform and apply grouping, summations and other
                                operations on the documents before they are returned to the application. It&rsquo;s a
                                very powerful unix pipe like framework. In this tutorial we will explore the <strong>aggregate</strong>
                                method on the <em>Collection</em> class and see how it can be used to return a cursor we
                                can iterate over. This cursor also implements the Node.js 0.10.x stream interface which
                                we will not cover in this tutorial. For more information about streams and the Node.js
                                driver please look in the <a href="/tutorials/streams">Streams Tutorial</a>.</p>
...
<pre><code class="language-js">var MongoClient = require('mongodb').MongoClient
    ...
    db.close();
                            ...
                            <p>When executing the <em>aggregate</em> method as a cursor it&rsquo;s important to
                                understand that on MongoDB 2.6 or higher this will use the native cursor support for the
                                aggregation framework on the server. If the server is 2.4 or earlier it will emulate the
                                cursor behavior with a virtual cursor. If a callback is included in the
                                <em>aggregate</em> command it will fall back to the legacy mode that returns the first
                                16MB of results.</p>

                            <p>The cursor returned by the <em>aggregate</em> command has the same available method as
                                the <em>find</em> cursor, namely the <em>toArray</em>, <em>next</em> and <em>each</em>
                                methods.</p>
