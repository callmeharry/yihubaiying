            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu active">
                    ...
                    <ul class="sub open">
                        ...
                        <li class="active"><a href="http://mongodb.github.io/tutorials/logging/"> Logging </a></li>
                ...
                <li><a href="https://github.com/mongodb/node-mongodb-native/docs/content/tutorials/logging.md"
                ...
                <div class="col-md-10">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <p>The driver lets you log at 3 different levels. These are <code>debug</code>,
                                <code>info</code> and <code>error</code>. By default the log level is at
                                <code>error</code>. You can change the level, only allow specific classes to log and
                                provide your own logger implementation. Let&rsquo;s look at how we control the log
                                level.</p>
...
<pre><code class="language-js">var MongoClient = require('mongodb').MongoClient
    ...
    db.close();
                            ...
                            <p>Setting the level is as easy as calling the method <code>setLevel</code> with the string
                                value <code>debug</code>, <code>info</code> or <code>error</code>. Log level is set
                                globally.</p>

                            <h2 id="toc_2">Filtering On specific classes</h2>

                            <p>Say you are only interested in logging a specific class. You can tell the Logger to only
                                log specific class names. Let&rsquo;s take an example Where we only log the
                                <code>Db</code> class.</p>
...
<pre><code class="language-js">var MongoClient = require('mongodb').MongoClient
    ...
    db.close();
                            ...
                            <p>This will only log statements on the <code>Db</code> class. The available classes in the
                                driver are.</p>
                            ...
                            <p>You can add your own classes to the logger if you wish by creating your own logger
                                instances. Let&rsquo;s look at a simple example on how to add our custom class to the
                                Logger.</p>
...
<pre><code class="language-js">var Logger = require('mongodb').Logger
    ...
    a.do();
                            ...
                            <p>Let&rsquo;s say you don&rsquo;t want the log statements to go to <code>console.log</code>
                                but want to send them to a new location or maybe transform them before you send them on.
                                Let&rsquo;s define our custom logger.</p>
