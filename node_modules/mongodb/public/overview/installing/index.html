            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu active">
                    ...
                    <ul class="sub open">
                        ...
                        <li class="active"><a href="http://mongodb.github.io/overview/installing/"> Installing The
                            Driver </a></li>
                ...
                <li><a href="https://github.com/mongodb/node-mongodb-native/docs/content/overview/installing.md"
        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-md-1">
                    ...
                    <a class="navigation prev" href="/overview/introduction">
                ...
                <div class="col-md-10">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <p>Installing the MongoDB Node.js driver using NPM is very easy. First you need to ensure
                                you have Node.js and NPM correctly set up and in your path. Installing the driver is as
                                easy as.</p>
...
<pre><code class="language-js">npm install
                ...
                <div class="col-md-1">
                    ...
                    <a class="navigation next" href="/overview/quickstart">
