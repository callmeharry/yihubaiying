            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu active">
                    ...
                    <ul class="sub open">
                        ...
                        <li class="active"><a href="http://mongodb.github.io/overview/introduction/"> Introduction </a>
                        </li>
                ...
                <li><a href="https://github.com/mongodb/node-mongodb-native/docs/content/overview/introduction.md"
        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-md-1">
                    ...
                    <a class="navigation prev" href="/overview/quickstart">
                ...
                <div class="col-md-10">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <p>The Node.js driver handles the connections to a single MongoDB server, a replicaset or a
                                set of Mongos proxies in a sharded system. It let&rsquo;s your application interact with
                                the server and lets it perform operations against the database.</p>
                ...
                <div class="col-md-1">
                    ...
                    <a class="navigation next" href="/overview/installing">
