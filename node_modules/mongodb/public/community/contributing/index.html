            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu active">
                    ...
                    <ul class="sub open">
                        ...
                        <li class="active"><a href="http://mongodb.github.io/community/contributing/"> Contributing </a>
                        </li>
                ...
                <li><a href="https://github.com/mongodb/node-mongodb-native/docs/content/community/contributing.md"
        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-md-1">
                    ...
                    <a class="navigation prev" href="/community/press">
                ...
                <div class="col-md-10">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <p>When you are ready to send us a pull request make sure you perform the following steps
                                first.</p>

                            <ul>
                                <li>Ensure you have at least one test case that covers the new code. If you are
                                    wondering how to do this please feel free to ask in the pull request for help.
                                </li>
                                ...
                                <li>Squash all your commits into a single commit. <code>git rebase -i</code>. You can
                                    force update your pull request as history for it is not important for us to keep.
                                </li>
                            </ul>
                            ...
                            <ol>
                                <li>Fork the Node.js driver from <a
                                        href="https://github.com/mongodb/node-mongodb-native">https://github.com/mongodb/node-mongodb-native</a>
                                </li>
                                ...
                                <li>Run tests suite (ensure mongodb is in path) (<code>node test/runner.js -t
                                    functional</code>)
                                </li>
...
<pre><code>node test/runner.js -t functional -e sharded
                ...
                <div class="col-md-1">
                    ...
                    <a class="navigation next" href="/tutorials/github_pages_blog">
