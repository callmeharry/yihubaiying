...
<section id="container" class="" style="height:100%">
    ...
    <header class="header black-bg">
        ...
        <div class="nav title-row" id="top_menu">
            <h1 class="nav top-menu"> API Documentation </h1>
        </div>
    </header>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu active">
                    ...
                    <ul class="sub open">
                        ...
                        <li class="active"><a href="http://mongodb.github.io/api-docs/"> API Documentation </a></li>
                ...
                <li><a href="https://github.com/mongodb/node-mongodb-native/docs/content/api-docs/index.html"
    ...
    <section id="main-content" style="margin-left:150px;height:100%">
                ...
                <div class="col-md-11" style="height:100%">
                    <section class="panel" style="height:100%">
                        <div class="panel-body" style="height:100%">
                            <iframe src="http://mongodb.github.io/api/index.html" frameborder="0"
