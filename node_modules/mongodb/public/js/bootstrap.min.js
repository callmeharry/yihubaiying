...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=6e6c0f9b837a5829ab1f)
 * Config saved to config.json and https://gist.github.com/6e6c0f9b837a5829ab1f
 */
...
+function (t) {
    ...
    i.VERSION = "3.2.0", i.DEFAULTS = {interval: 5e3, pause: "hover", wrap: !0}, i.prototype.keydown = function (t) {
        ...
        var p = n[0], h = t.Event("slide.bs.carousel", {relatedTarget: p, direction: r});
        if (this.$element.trigger(h), !h.isDefaultPrevented()) {
            ...
            var f = t.Event("slid.bs.carousel", {relatedTarget: p, direction: r});
            ...
            }).emulateTransitionEnd(1e3 * o.css("transition-duration").slice(0, -1))) : (o.removeClass("active"), n.addClass("active"), this.sliding = !1, this.$element.trigger(f)), s && this.cycle(), this
        }
    };
    var o = t.fn.carousel;
    ...
    i.VERSION = "3.2.0", i.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var p = this.getPosition(), h = n[0].offsetWidth, d = n[0].offsetHeight;
            if (l) {
                var f = r, c = this.$element.parent(), u = this.getPosition(c);
                r = "bottom" == r && p.top + p.height + d - u.scroll > u.height ? "top" : "top" == r && p.top - u.scroll - d < 0 ? "bottom" : "right" == r && p.right + h > u.width ? "left" : "left" == r && p.left - h < u.left ? "right" : r, n.removeClass(f).addClass(r)
            }
            var g = this.getCalculatedOffset(r, p, h, d);
        ...
        var d = h.left ? 2 * h.left - n + l : 2 * h.top - s + p, f = h.left ? "left" : "top", c = h.left ? "offsetWidth" : "offsetHeight";
        o.offset(e), this.replaceArrow(d, o[0][c], f)
    ...
    i.VERSION = "3.2.0", i.RESET = "affix affix-top affix-bottom", i.DEFAULTS = {
        ...
        if (this.$element.is(":visible")) {
            ...
            if (this.affixed !== l) {
                ...
                this.$element.trigger(h), h.isDefaultPrevented() || (this.affixed = l, this.unpin = "bottom" == l ? this.getPinnedOffset() : null, this.$element.removeClass(i.RESET).addClass(p).trigger(t.Event(p.replace("affix", "affixed"))), "bottom" == l && this.$element.offset({top: e - this.$element.height() - a}))
            }
        }
    };
    var o = t.fn.affix;
    ...
    t.fn.collapse = e, t.fn.collapse.Constructor = i, t.fn.collapse.noConflict = function () {
        ...
        var o, n = t(this), s = n.attr("data-target") || i.preventDefault() || (o = n.attr("href")) && o.replace(/.*(?=#[^\s]+$)/, ""), r = t(s), a = r.data("bs.collapse"), l = a ? "toggle" : n.data(), p = n.attr("data-parent"), h = p && t(p);
