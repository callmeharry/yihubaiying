...
<head>
    <meta charset="utf-8">
    <title>Source: lib/mongo_client.js</title>
...
<div id="wrap" class="clearfix" style="width:100%;">
    <table style="height:100%;width:100%">
        <tr>
            <td valign='top'>
                <div class="main">
                    <h1 class="page-title" data-filename="mongo_client.js.html">Source: lib/mongo_client.js</h1>


                    <section>
                        <article>
            <pre class="prettyprint source linenums"><code>var parse = require('./url_parser')
                ...
                * @param {boolean} [options.uri_decode_auth=false] Uri decode the user name and password for
                authentication
                * @param {object} [options.db=null] A hash off options to set on the db object, see **Db constructor**
                * @param {object} [options.server=null] A hash off options to set on the server objects, see **Server**
                constructor**
                * @param {object} [options.replSet=null] A hash off options to set on the replSet object, see
                **ReplSet** constructor**
                * @param {object} [options.mongos=null] A hash off options to set on the mongos object, see **Mongos**
                constructor**
