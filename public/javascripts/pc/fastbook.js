...
function first(preP,preC,formname,selectP,selectC)
{
    ...
    if (selectP=='02')
    { a=2;tempoption=new Option('天津市','02',false,true); }
    else
    { tempoption=new Option('天津市','02'); }
    ...
    if (selectP=='03')
    { a=3;tempoption=new Option('武汉','03',false,true); }
    else
    { tempoption=new Option('武汉','03'); }
    ...
    if (selectP=='04')
    { a=4;tempoption=new Option('上海','04',false,true); }
    else
    { tempoption=new Option('上海','04'); }
    ...
    if (selectP=='05')
    { a=5;tempoption=new Option('广州','05',false,true); }
    else
    { tempoption=new Option('广州','05'); }
